...
def generate_launch_description():
    ...
    orientation = [0.0, 0.0, -1.57]  # Roll, Pitch, Yaw in radianti (es. 90 gradi di rotazione su yaw)

 #    position = [0.0, 0.0, 0.1]

  #   orientation = [0.0, 0.0, 0.0]  # Roll, Pitch, Yaw in radianti (es. 90 gradi di rotazione su yaw)
